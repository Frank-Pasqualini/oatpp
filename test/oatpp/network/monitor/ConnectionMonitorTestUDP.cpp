...
#include "ConnectionMonitorTestUDP.hpp"
...
void runClient() {
  ...
  auto connectionProvider = oatpp::network::udp::client::ConnectionProvider::createShared(
    {"localhost", 8000});
...
void ConnectionMonitorTestUDP::onRun() {

  auto connectionProvider = oatpp::network::udp::server::ConnectionProvider::createShared(
    {"localhost", 8000});
