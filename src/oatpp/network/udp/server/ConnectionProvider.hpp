...
#include "oatpp/network/udp/ConnectionConfigurer.hpp"
...
/**
 * Simple provider of UDP connections.
 */
...
public:
   ...
   */
  class ExtendedConnection : public oatpp::network::udp::Connection {
  public:
...
public:
   ...
   * `false` to use &id:oatpp::network::udp::Connection;.
   */
